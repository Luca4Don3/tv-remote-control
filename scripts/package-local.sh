...
build_windows() {
    ...
    cp "$controller_dir/vendor/android-sdk-license.txt" "$package_dir/LICENSE-android-platform-tools.txt"
    if [ "$label" != x86 ]; then
...
cp "$controller_dir/vendor/android-sdk-license.txt" "$app/Contents/Resources/LICENSE-android-platform-tools.txt"
