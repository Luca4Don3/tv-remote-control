...
enum class BackendKind { NONE, VENDOR, ADB }

object BackendSelection {
    fun select(vendorAvailable: Boolean, adbAllowed: Boolean, adbAvailable: Boolean): BackendKind = when {
        vendorAvailable -> BackendKind.VENDOR
