...
class ProjectionService : Service() {
    ...
    companion object {
        private const val ACTION_START_AUTHORIZED = "dev.tvremote.agent.START_PROJECTION_AUTHORIZED"
        private const val ACTION_STOP = "dev.tvremote.agent.STOP_PROJECTION"
