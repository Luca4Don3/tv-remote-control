...
import dev.tvremote.agent.auth.KeyFault
import dev.tvremote.agent.auth.KeystoreRecovery
...
class AdbIdentityStore(private val context: Context) {
    private val prefs = context.getSharedPreferences("agent_adb_identity", Context.MODE_PRIVATE)
    ...
    companion object {
        ...
        private const val ALIAS = "agent_local_adb_wrap_v1"
    }
}
