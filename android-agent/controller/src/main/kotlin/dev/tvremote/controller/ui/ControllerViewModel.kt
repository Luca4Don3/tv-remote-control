...
import dev.tvremote.controller.BuildConfig
import dev.tvremote.controller.data.KeystoreCredentialStore
import dev.tvremote.controller.net.DiscoveryClient
import dev.tvremote.controller.net.TvConnection
...
class ControllerViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun submitPairingInvitation(invitation: dev.tvremote.controller.pairing.PairInvitation) =
